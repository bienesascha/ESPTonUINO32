...
String getFooter() {
  ...
  footer += "<p class='text-muted'>Version: 3.1.1 compiletime: ";
  footer += compile_date;
  footer += "</p>";
  footer += "</div>";
  footer += "</footer>";
...
page += "<html>";
page += "<head>";
page += "<title>ESPTonUINO Interface</title>";
page += "<meta name='viewport' content='width=device-width, initial-scale=1'>";
page += "<meta name='author' content='C. Ulbrich / M.Schwager'>";
...
page += "          <h1 class='display-1'><font face='Comic sans MS'>Wilkommen im ESPTonUINO</font></h1>";
page += "          <h1 class=''>hier koennen Sie ihren ESPTonUINO konfigurieren und steuern</h1>";
page += "        </div>";
page += "    </div>";
page += " <hr />";
page += "  </div>";
...
page += " <p> Aktuelle Lautstaerke einstellen...Wert: <span id='aktValue'></span></p>";
page += " <input type='range' min='0' max='30' value='10' name='akt_volume' class='slider' id='myAktVolRange'>";
page += " <p> Maximale Lautstaerke einstellen...Wert: <span id='maxValue'></span></p>";
...
page += "            </p>";
page += "            <div class='blockquote-footer'>Zeiten zum Ein- und Ausschalten der Box festgelegt werden</div>";
page += "          </div>";
page += "          <form>";
...
page += "          </div>";
page += "          <ol>";
page += "            <li>Hoerspielmodus</li>";
page += "            <li>Partymodus</li>";
page += "            <li>Hoerbuchmodus</li>";
page += "            <li>Partymodus</li>";
page += "          </ol>";
...
page += "        </div>";
page += "        <div>";
page += "          <br> Zum aendern eines TAG hier ID,Ordner,Wiedergabemodus eingeben:";
page += "          <br>";
page += "     <form action='/'> Eingabe:  ";
page += "       <input type='text' name='cng-rfid-tag'> &nbsp ";
page += "       <input type='submit' value='uebernehmen' class='btn btn-outline-success'>";
page += "       </br>";
page += "     </form>";
page += "    </div>";
...
page += "            </p>";
page += "            <div class='blockquote-footer'>Hier kann die Farbe und Helligkeit des ESPTonUNIO eingestellt werden</div>";
page += "       <form>";
...
page += "<html>";
page += "<head>";
page += "<title>ESPTonUINO WiFi Setup</title>";
...
page += " </form>";
page += "<br>Erst speichern dann restart.";
page += "</head>";
page += "</html>";
